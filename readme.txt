...
5. All files (except shortcuts) on desktop will be moved to subfolder named as per the file extension in documents folder and it will show 10 largest files for all the drives present in computer.
